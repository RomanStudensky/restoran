...
@Controller
@RequestMapping("/cook/product")
@RequiredArgsConstructor
public class ProductController {

    private final String REDIRECT_URL = "redirect:/cook/product/%s";
    private final String COMMON_VIEW =  "/cook/product/commonView";
    private final String CREATE_PRODUCT_VIEW = "/cook/product/action/create";
    private final String UPDATE_PRODUCT_VIEW = "/cook/product/action/update";
