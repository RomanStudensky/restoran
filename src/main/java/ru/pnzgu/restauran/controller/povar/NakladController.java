...
public class NakladController {
    ...
    private final String REDIRECT_URL = "redirect:/povar/naklad/%s";
    private final String COMMON_VIEW =  "/povar/naklad/commonView";
    private final String CREATE_NAKLAD_VIEW = "/povar/naklad/action/naklad/create";
    private final String UPDATE_NAKLAD_VIEW = "/povar/naklad/action/naklad/update";
    private final String CREATE_SOSTAV_POSTAV_VIEW = "/povar/naklad/action/sostav/create";
