...
@Controller
@RequestMapping("/cook/categ")
@RequiredArgsConstructor
public class CathegController {

    private final String REDIRECT_HOME_URL = "redirect:/cook/categ";
    private final String REDIRECT_CATEG_URL = "redirect:/cook/categ/%s";
    private final String REDIRECT_MENU_URL = "redirect:/cook/categ/menu/%s/%s";
    private final String COMMON_VIEW = "/cook/categ/commonView";

    private final String CREATE_CATEG_VIEW = "/cook/categ/action/categ/create";
    private final String UPDATE_CATEG_VIEW = "/cook/categ/action/categ/update";

    private final String CREATE_MENU_VIEW = "/cook/categ/action/menu/create";
    private final String UPDATE_MENU_VIEW = "/cook/categ/action/menu/update";

    private final String CREATE_SOSTAV_MENU_VIEW = "/cook/categ/action/sostav/create";
    private final String UPDATE_SOSTAV_MENU_VIEW = "/cook/categ/action/sostav/update";
