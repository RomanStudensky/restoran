...
@Controller
@RequestMapping("/povar/order")
@RequiredArgsConstructor
public class OrdersController {

    private final String REDIRECT_URL = "redirect:/povar/order/%s";
    private final String COMMON_VIEW =  "/povar/order/commonView";
    private final String CREATE_ORDER_VIEW = "/povar/order/action/order/create";
    private final String UPDATE_ORDER_VIEW = "/povar/order/action/order/update";
    private final String CREATE_SOSTAV_POSTAV_VIEW = "/povar/order/action/sostav/create";
